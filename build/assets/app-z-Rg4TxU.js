...
const tt = v("string"),
    ...
    [lt, ft, dt, pt] = ["ReadableStream", "Request", "Response", "Headers"].map(
        C
    ),
    ht = (e) =>
...
const mt = (e, t, n, { allOwnKeys: r } = {}) => (
    ...
    me = "0123456789",
    De = { DIGIT: me, ALPHA: Q, ALPHA_DIGIT: Q + Q.toUpperCase() + me },
    Ft = (e = 16, t = De.ALPHA_DIGIT) => {
        let n = "";
        const { length: r } = t;
...
const Bt = (e) => {
    ...
    Dt = C("AsyncFunction"),
    Ut = (e) => e && (K(e) || x(e)) && x(e.then) && x(e.catch),
    Ue = ((e, t) =>
        e
            ? setImmediate
            : t
    ...
    kt =
        typeof queueMicrotask < "u"
            ...
            : (typeof process < "u" && process.nextTick) || Ue,
    a = {
        isArray: U,
        isArrayBuffer: Pe,
        isBuffer: Ye,
...
function X(e, t, n) {
    ...
    function l(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            if (a.endsWith(y, "{}"))
                ...
                (a.isArray(p) && qt(p)) ||
                ((a.isFileList(p) || a.endsWith(y, "[]")) && (b = a.toArray(p)))
            )
                return (
                    (y = qe(y)),
    ...
    function R(p, y) {
        if (!a.isUndefined(p)) {
            ...
            d.push(p),
                a.forEach(p, function (b, S) {
                    (!(a.isUndefined(b) || b === null) &&
                        s.call(t, b, a.isString(S) ? S.trim() : S, y, w)) ===
                        !0 && R(b, y ? y.concat(S) : [S]);
                }),
                d.pop();
        }
    }
...
const Me = {
    ...
    Mt = typeof URLSearchParams < "u" ? URLSearchParams : ue,
    zt = typeof FormData < "u" ? FormData : null,
    Jt = typeof Blob < "u" ? Blob : null,
    Vt = {
        isBrowser: !0,
        classes: { URLSearchParams: Mt, FormData: zt, Blob: Jt },
    ...
    vt = (le && window.location.href) || "http://localhost",
    Kt = Object.freeze(
        ...
        return (
            ...
            f
                ...
                : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
                  t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Qt(s[i])),
                  !c)
        );
    }
...
const I = {
    ...
    transformRequest: [
        function (t, n) {
            ...
            return o || s
                ? (n.setContentType("application/json", !1), Zt(t))
                : t;
        },
    ],
    transformResponse: [
...
`);
    ...
    static accessor(t) {
        const r = (this[Ee] = this[Ee] = { accessors: {} }).accessors,
            s = this.prototype;
        function o(i) {
            const c = j(i);
            r[c] || (sn(s, i), (r[c] = !0));
...
const V = (e, t, n = 3) => {
    ...
    un = T.hasStandardBrowserEnv
        ? (function () {
              const t =
                      T.navigator &&
                      /(msie|trident)/i.test(T.navigator.userAgent),
...
const $e = (e) => {
        ...
        (t.headers = i = A.from(i)),
            (t.url = Ie(We(t.baseURL, t.url), e.params, e.paramsSerializer)),
            c &&
                i.set(
                    "Authorization",
                    "Basic " +
        ...
        function (e) {
            return new Promise(function (n, r) {
                ...
                "onloadend" in h
                    ...
                    (h.onabort = function () {
                        h &&
                            (r(new m("Request aborted", m.ECONNABORTED, e, h)),
                            (h = null));
                    }),
                    (h.onerror = function () {
                        r(new m("Network Error", m.ERR_NETWORK, e, h)),
                            (h = null);
                    }),
                    ...
                    "setRequestHeader" in h &&
                        a.forEach(i.toJSON(), function (N, O) {
            ...
            const o = function (u) {
                if (!s) {
                    ...
                    r.abort(
                        l instanceof m
                            ? l
                            : new k(l instanceof Error ? l.message : l)
                    );
                }
            };
            let i =
    ...
    wn = async function* (e, t) {
        for await (const n of bn(e)) yield* yn(n, t);
    },
    bn = async function* (e) {
    ...
    ve = G && typeof ReadableStream == "function",
    En =
        G &&
    ...
    Te = 64 * 1024,
    se = ve && Ke(() => a.isReadableStream(new Response("").body)),
    W = { stream: se && ((e) => e.body) };
G &&
    ((e) => {
...
const Sn = async (e) => {
    ...
    On =
        ...
        (async (e) => {
            ...
            let R = mn([s, o && o.toAbortSignal()], i),
                p;
            const y =
                R &&
                R.unsubscribe &&
            ...
            try {
                ...
                let S = await fetch(p);
                const g = se && (u === "stream" || u === "response");
                if (se && (c || (g && y))) {
                    const O = {};
        ...
        getAdapter: (e) => {
            ...
            for (let o = 0; o < t; o++) {
                ...
                if (
                    ((r = n),
                    !Tn(n) &&
                        ((r = oe[(i = String(n)).toLowerCase()]), r === void 0))
                )
...
function xe(e) {
    return (
        ...
        Xe.getAdapter(e.adapter || I.adapter)(e).then(
            function (r) {
                return (
                    ee(e),
...
const ie = { assertOptions: An, validators: fe },
    _ = ie.validators;
class B {
    constructor(t) {
        (this.defaults = t),
...
a.forEach(["delete", "get", "head", "options"], function (t) {
    B.prototype[t] = function (n, r) {
        return this.request(
            D(r || {}, { method: t, url: n, data: (r || {}).data })
        );
    };
});
